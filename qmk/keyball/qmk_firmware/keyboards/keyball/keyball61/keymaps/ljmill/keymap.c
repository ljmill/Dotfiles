...
#include "quantum.h"
/*
This mapping is not used. I am remapping in Remap where I have various keymaps stored.
Only things that concern me here are the number of layers. 
In the future, when I have settled on a keymapping, I will code it into here.
*/
// clang-format off
